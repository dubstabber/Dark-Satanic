...
#   * src/**/*.gd line counts: note > 500, warn > 700, FAIL > 900
#   * autoloads (EventBus/RunManager/AudioManager/SettingsManager) may only be referenced from
...
bad=$(grep -rnE '\b(EventBus|RunManager|SettingsManager)\.' src --include='*.gd' \
